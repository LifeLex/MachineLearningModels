...
multi_disease_model.save('modelo_NIH_Sigmoid25062020.h5')
...
plt.show()
fig.savefig('barely_trained_net2506.png')
...
c_ax.set_ylabel('True Positive Rate')
plt.show()
fig.savefig('trained_net2506.png')
...
for (idx, c_ax) in zip(sickest_idx, m_axs.flatten()):
    ...
    c_ax.axis('off')
plt.show()
fig.savefig('trained_img_predictions2506.png')

from keras.preprocessing import image


test_image = image.load_img(r'D:\DescargasChrome\input\images_001\images\00000020_002.png', color_mode='grayscale')
imgplot = plt.imshow(test_image)
plt.show()
test_image = image.img_to_array(test_image)
test_image = np.expand_dims(test_image, axis=0)
result= multi_disease_model.predict(test_image)
result_classes= multi_disease_model.predict_classes(test_image)
